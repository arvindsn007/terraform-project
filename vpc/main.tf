...
resource "aws_route_table" "public_route" {
  ...
  tags = {
    Name = "${var.default_name}-public-route"
  }
}
...
resource "aws_default_route_table" "private_route" {
  ...
  tags = {
    Name = "${var.default_name}-private-route"
  }
}
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name = "${var.default_name}-public-subnet.${count.index + 1}"
  }
}
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name = "${var.default_name}-private-subnet.${count.index + 1}"
  }
}
